...
\relative c'' {
	...
	\mark \default %B
        \clef "alto"
        \oneVoice
		<d, fis b>4\f^\pizz r8 q q4 r8 <e, d' gis b>8 |
	...
	\mark \default %D 
		...
		\stopMeasureCount
		a-._\icresc^\arco[ r8 a-.(] <g a>-.)[ r8 <g a>-.(] |
		...
		\barNumberCheck #321
		R1*6/4 | 
		r4 r8^\arco a\downbow\f r8 r8 |
		g\downbow r8 r8 f\downbow r r | 
		e\downbow r r r4 r8 |
		\repeat unfold 4 
		{
			R1*3/4 | 
			r4 r8 a\downbow\f r8 r8 |
			g\downbow r8 r8 f\downbow r r | 
			e\downbow r r r4 r8 |
		}
		R1*3/4 | 
		...
		fis4 fis( b2)~ | 
		b4(cis) \grace {b16( cis} b4)( a8 gis) |
		a8( gis fis4)~ fis2 | 
		fis4( gis a cis) |
		...
		>> 
		\oneVoice
		<c fis a>4^\markup{\tiny "unis."} q r q | 
		q q r q |
		<b fis' b>4 q r q |
		<<
			{\voiceOne <b gis'>q r gis' | 
		gis gis\> r4 gis | 
		gis gis r gis|}
			\new Voice
			{\voiceTwo <d fis>4 q r <b fis'> | 
		q q r q | 
		<b eis> q r q |}
		...
		\barNumberCheck #523
		R1*6/4 | 
		r4 r8^\arco g\downbow\f r8 r8 |
		f\downbow r8 r8 e\downbow r r | 
		d\downbow r r r4 r8 |
		\repeat unfold 4 {R1*3/4 | 
		r4 r8 g\downbow\f r8 r8 |
		f\downbow r8 r8 e\downbow r r | 
		d\downbow r r r4 r8 |}
		R1*3/4 | 
		r4 r8 g\downbow\f r8 r8 |
		...
		\scaleDurations 3/2 
		{
			aes'16->\f( g aes g aes8) r | 
			aes16->( g aes g aes8) r | 
			g16->(f g f g8) r | 
			g16->(f g f g8) r |
			f16->(e f e f8) r | 
			f16->(e f e f8) r | 
